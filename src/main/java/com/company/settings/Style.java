...
public class Style {
    ...
    public static final Font FONT_BUTTON_TOOLBAR = new Font("Consolas", Font.BOLD, 14);
    public static final Font FONT_MAIN_BUTTON = new Font("Consolas", Font.BOLD, 14);
    ...
    public static final ImageIcon ICON_TOOLBAR_ACCOUNTS = new ImageIcon("images/acconts.png");
